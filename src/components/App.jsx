...
import StatisticSensor from './statistics/Statistic-sensor.jsx';
      ...
      <BrowserRouter>
        ...
        <div className={clsx('order-padding', {
          ...
          <Switch>
            ...
            <Route exact path="/real-time" component={ChartRealTime} />
            <Route exact path="/statistics/:sensor" component={StatisticSensor} />
          </Switch>
        </div>
